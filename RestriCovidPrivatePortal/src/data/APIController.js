...
export const DatosRestricciones = async () => {
    const url = 'http://51.137.96.183:5001/RestriCovid/restricciones';
    let datos = [];
...
export const EliminarRestriccionPoblacion = async (idRestriccion,idPoblacion) => {
    let url = `http://51.137.96.183:5001/RestriCovid/deleteRestriccionPoblacion/?idRestriccion=${idRestriccion}&idPoblacion=${idPoblacion}`;
...
export const AsignarRestriccion = async (idPoblacion,idRestriccion) => {
    let url = `http://51.137.96.183:5001/RestriCovid/insertRestriccionPoblacion/?idRestriccion=${idRestriccion}&idPoblacion=${idPoblacion}`;
